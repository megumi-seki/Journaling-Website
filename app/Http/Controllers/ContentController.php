...
class ContentController
{
    ...
    public function store(StoreContentRequest $request)
    {
        ...
        return redirect()->route("content.index")->with("success", "new journal was saved successfully");
    }
    ...
    public function update(StoreContentRequest $request, Content $content)
    {
        ...
        return redirect()->route("content.index")->with("success", "the content was updated successfully");
    }
    ...
    public function destroy(Content $content)   {
        ...
        return redirect()->route("content.index")->with("success","the content was successdully deleted");
    }
    ...
    public function expand(Request $request)
    {
        $contentId = $request->query("content_id");
        $content = Content::find($contentId);
        // return redirect()->route("content.expand", $content);
        return view("content.expand", $content);
    }
