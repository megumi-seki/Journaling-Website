<x-guest-layout>
        <form action="#" method="GET" class="flex-col align-center gap-small mtb-small">
            ...
            <input type="text" name="name" placeholder="Enter your name" class="input-def">
            <input type="email" name="email" placeholder="Enter your email" class="input-def">
            <input type="text" name="phone" placeholder="Enter your phone number" class="input-def">
            <input type="password" name="password" placeholder="Create your password" class="input-def">
